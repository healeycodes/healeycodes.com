...
export default function Projects({ totalStars, totalForks, mostRecentPushFormatted }: { totalStars: number, totalForks: number, mostRecentPushFormatted: string }) {
  return (
    ...
    >
      ...
      <main>
        <p>
          My side projects include programming languages, web frameworks, game solvers, developer tools, databases, and games. My public GitHub repositories been starred {totalStars} times, and my last open source <code>git push</code> was {mostRecentPushFormatted} ago (this section updates <a href="https://github.com/healeycodes/healeycodes.com/blob/7d9881e0dfea6b81eef173a7dc98186b20ce6eae/pages/projects.tsx#L90">every half an hour</a>).
        </p>
        <h2>Open Source</h2>
